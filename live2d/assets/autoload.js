// 加载 CSS
$("<link>").attr({href: "https://ecnudayun.github.io/live2d/assets/waifu.css", rel: "stylesheet", type: "text/css"}).appendTo('head');
...
// 加载 JS
$.ajax({
	url: 'https://ecnudayun.github.io/live2d/assets/live2d.js',
	dataType:"script",
	cache: true,
	async: false
});
$.ajax({
	url: 'https://ecnudayun.github.io/live2d/assets/waifu-tips.js',
	dataType:"script",
	cache: true,
	async: false
});
...
initModel('https://ecnudayun.github.io/live2d/assets/');